...
export default function RentPropertyPage() {
  ...
  const [sortValue, setSortValue] = React.useState<
    "just_posted" | "rent_low" | "rent_high" | "area"
  >("just_posted");
  ...
  const { sortKey, sortOrder } = React.useMemo(() => {
    // NOTE: your backend must support these keys.
    // If not, keep sortKey="createdAt" for all cases.
    switch (sortValue) {
      case "rent_low":
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-10 2xl:px-14 py-10 space-y-6">
        ...
        <section className="bg-[#141414] border border-[#262626] rounded-xl p-6 md:p-8">
          <div className="mt-3 flex flex-col gap-3">
            <h1 className="text-3xl md:text-4xl font-bold text-white">
              Rent Properties{" "}
              <span className="text-white/50">(Rent Property)</span>
            </h1>
            <p className="text-white/60 max-w-3xl">
              Search by location, monthly rent range, area, bedrooms/bathrooms,
              amenities, and nearby utilities.
            </p>
          </div>
        </section>
        ...
        <section className="bg-[#141414] border border-[#262626] rounded-xl p-5 md:p-6">
          ...
          <div className="mt-4 flex items-center gap-2 flex-wrap">
            {["Hà Nội", "2PN+", "2WC+", "8-15 triệu/tháng", "Near Metro"].map(
              (filter) => (
                <button
                  key={filter}
        ...
        <section className="grid grid-cols-1 lg:grid-cols-[320px_1fr] gap-6">
          {/* Left: Sidebar filters (UI only - you can wire later) */}
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["Balcony", "Furnished", "Parking", "Gym", "Pool", "Elevator"].map(
                      (amenity) => (
                        <button
                          key={amenity}
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["School", "Hospital", "Supermarket", "Park", "Metro"].map(
                      (utility) => (
                        <button
                          key={utility}
                          className="bg-[#0a0a0a] border border-[#262626] text-white/80 px-3 py-1.5 rounded-lg text-sm hover:border-purple-600 hover:text-purple-400 transition-colors"
                ...
                <Button
                  ...
                  onClick={() => {
                    // currently only search + sort is wired.
                    postsQ.refetch();
                  }}
                >
                  Apply Filters
                ...
                <div className="pt-6 border-t border-[#262626]">
                  ...
                  <p className="text-white/60 text-sm mb-4">
                    Save your search and get notified when matching rental
                    listings are posted.
                  </p>
                  <Button
                    variant="outline"
                    className="w-full border-[#262626] text-white hover:bg-white/5 bg-transparent"
                  >
                    Save Search
                  </Button>
                </div>
          ...
          <div className="space-y-6">
                ...
                <div className="flex flex-wrap items-center gap-3 md:gap-4">
                  <div className="flex items-center gap-2">
                    ...
                    <select
                      value={sortValue}
                      onChange={(e) =>
                        setSortValue(e.target.value as typeof sortValue)
                      }
            ...
            {postsQ.isLoading ? (
              ...
              <div className="bg-[#141414] border border-[#262626] rounded-xl p-10 md:p-12">
                <div className="text-white/70">Failed to load rent listings.</div>
                <Button
